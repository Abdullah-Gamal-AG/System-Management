...
public partial class DeleteProduct : Form
{
	...
	public DeleteProduct()
	{
		...
		productNameInput = new TextBox
		{
			Location = new Point(x, num),
			Width = width,
			PlaceholderText = "Exactly as it appears in inventory..."
		};
		num += 50;
		...
		base.Controls.AddRange(label, label2, label3, productNameInput, statusLabel, button);
